<header>
    <nav class="navbar navbar-expand-md bg-body shadow-sm py-1 py-md-0">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center justify-content-center" href="/">
                <img src="assets/img/upicon.png" class="d-inline-block align-top upicon-logo">
                <span>&nbsp;&nbsp;</span>
            ...
            <div class="collapse navbar-collapse" id="navcol-2">
                <ul class="navbar-nav ms-auto d-flex align-items-center justify-content-center">
                    ...
                    <li class="nav-item">
                        <div class="theme-switcher dropdown"><a class="dropdown-toggle px-3" aria-expanded="false"
                                data-bs-toggle="dropdown" href="#"><svg xmlns="http://www.w3.org/2000/svg"
